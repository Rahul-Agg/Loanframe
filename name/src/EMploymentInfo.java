...
public class EMploymentInfo {
    ...
    public static void main(String args[]) throws IOException{
        ...
        List<EMploymentInfo> li=new ArrayList<>();
      ...
      // String str="EM03E0101021002081103201503020180081103201582039998308110320158406EM0001   ";
        String word="EM03E01";
        String accountType,errorcode,cibilremarkscode,disputeremarkscode;
        String dateReported,dateerrorcode,datecibilremarks,datedisputeremarks;
        String frequency;
        String income;
        ...
        for (i = -1; (i = str.indexOf(word, i-1 )) != -1; i++)
        {
            ...
            if(tag.equals("01"))
            {
                keyValueMap=createKeyValueMap("AccountTypeTable.txt",2);
                i=i+4;
                value=str.substring(i,i+2);
                i=i+2;
                accountType=keyValueMap.get(value);
                System.out.println("Acoount type is: "+accountType);
                tag=str.substring(i,i+2);
            }
            ...
            if(tag.equals("02"))
            {
                ...
                i=i+8;
                System.out.println("Date reported is: "+dateReported);
                tag=str.substring(i,i+2);
            }
            if(tag.equals("03"))
            {
            ...
            if(tag.equals("80"))
            {
                ...
                i=i+8;
                System.out.println("Date of entry for error code: "+dateerrorcode);
                tag=str.substring(i,i+2);
            }
            if(tag.equals("82"))
            {
                keyValueMap=createKeyValueMap("ErrorCodes.txt",3);
                i=i+4;
            ...
            if(tag.equals("83"))
            {
                ...
                i=i+8;
                System.out.println("Date of entry for cibil remarks: " +datecibilremarks);
                tag=str.substring(i,i+2);
            }
            if(tag.equals("84"))
            {

                keyValueMap=createKeyValueMap("RemarksCodes.txt",6);
                i=i+4;
            ...
            if(tag.equals("85"))
            {
                ...
                i=i+8;
                System.out.println("Date of entry for Dispute Remarks: "+datedisputeremarks);
                tag=str.substring(i,i+2);
            ...
            if(tag.equals("86"))
            {
                ...
                System.out.println("Dispute remarks is: "+disputeremarkscode);
                tag=str.substring(i,i+2);
      ...
      static Map<String,String> createKeyValueMap(String fileName,int index) throws IOException{
        FileReader file = new FileReader("C:\\Users\\LoanFrame User\\Desktop\\"+fileName);
        ...
        while((st=bf.readLine())!=null)
        {
            ...
            String accountType=(st.substring(index)).trim();
