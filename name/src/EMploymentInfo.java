...
public class EMploymentInfo {
    ...
    public static void main(String args[]) throws IOException{
        ...
        String str="EM03E0101021002081103201503020180081103201582039998308110320158406EM0001";
        String word="EM03E01";
        String accountType,errorcode,cibilremarkscode;
        String dateReported,dateerrorcode,datecibilremarks;
        String frequency;
        String income;
        ...
        for (i = -1; (i = str.indexOf(word, i-1 )) != -1; i++)
        {
            ...
            {
                i=i+4;
                dateerrorcode=str.substring(i,i+8);
                i=i+8;
                System.out.println(dateerrorcode);
                tag=str.substring(i,i+2);
                System.out.println(i);
            }
            if(tag.equals("82"))
            {
                ...
                i=i+3;
                errorcode=keyValueMap.get(value);
            ...
            {
                i=i+4;
                datecibilremarks=str.substring(i,i+8);
                i=i+8;
                System.out.println(datecibilremarks);
                tag=str.substring(i,i+2);
            }
            if(tag.equals("84"))
            {
                ...
                i=i+6;
                cibilremarkscode=keyValueMap.get(value);
                System.out.println("cibil remarks  code is: "+cibilremarkscode);
                tag=str.substring(i,i+2);              
            }
            if(tag.equals("85"))
            {
                ...
                i=i+4;
                datedisputeremarks=str.substring(i,i+8);
                i=i+8;
                System.out.println(datedisputeremarks);
                tag=str.substring(i,i+2);
            }
            if(tag.equals("86"))
            {
             i=i+4;
             value=str.substring(i,i+i+6);
             i=i+6;
             disputeremarkscode="Disputed accepted – under investigation ";
             System.out.println(disputeremarkscode);
                tag=str.substrin(i,i+2);
     ...
     static void createKeyValueMap(name, number) throws IOException{
        ...
        while((st=bf.readLine())!=null)
        {
            ...
            String value=stn.nextToken();
            String accountType=(st.substring(2)).trim();
            keyValueMap.put(value,accountType);
        }
    }
    static void createKeyValueMap1() throws IOException{
        FileReader file1 = new FileReader("C:\\Users\\LoanFrame User\\Desktop\\ErrorCodes.txt");
        ...
        while((st=bf.readLine())!=null)
        {
            StringTokenizer stn =new StringTokenizer(st);
            String value=stn.nextToken();
            String accountType=(st.substring(3)).trim();
            keyValueMap.put(value,accountType);
        }
    }
    static void createKeyValueMap2() throws IOException{
        FileReader file2 = new FileReader("C:\\Users\\LoanFrame User\\Desktop\\CibilRemarksCodes.txt");
        ...
        while((st=bf.readLine())!=null)
        {
            StringTokenizer stn =new StringTokenizer(st);
            String value=stn.nextToken();
            String accountType=(st.substring(6)).trim();
            keyValueMap.put(value,accountType);
        }
    }
